$(document).ready(function () {
    ...
    $('.btn').on('click', function () {
        ...
        if (this.id === "previous") {
            ...
            //Check if data in getPokemon has property 'previous'
            //How do I get to it since it is local to that function, right?
            //Should this code go in that function instead?
